  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (meResponse.status === 401) {
        setError("Please sign in to manage organizations.");
        setLoading(false);
        return;
      }
        ...
        <div className="flex-1">
          ...
          <div className="w-full px-6 pb-12 pt-8">
            ...
            <div className="mb-10">
              ...
              <h1 className="mt-1 text-2xl font-semibold text-black/90">Organizations</h1>
              <p className="mt-1 text-sm text-black/60">
                Manage teams, roles, and shared workspaces.
              </p>
            </div>
            ...
            <section className="rounded-2xl border border-black/5 bg-white/60 p-5 shadow-sm shadow-black/5 backdrop-blur-sm">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t border-black/10 pt-6">
                <p className="text-xs text-black/50">Need to invite teammates?</p>
                <Link
